        ...
        return spaces.Dict(
            {
                ...
                "submarines": spaces.Box(
                    low=0, high=160, shape=(12, 5), dtype=jnp.int32
                ),
                "divers": spaces.Box(low=0, high=160, shape=(4, 5), dtype=jnp.int32),
                "enemy_missiles": spaces.Box(
                    low=0, high=160, shape=(4, 5), dtype=jnp.int32
                ),
                ...
                "collected_divers": spaces.Box(
                    low=0, high=6, shape=(), dtype=jnp.int32
                ),
