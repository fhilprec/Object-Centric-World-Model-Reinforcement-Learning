...
The Dreamer architecture \cite{hafner2020dream} is a family of model-based RL algorithms (DreamerV1,
...
\begin{figure}[ht]
	...
	\caption[DreamerV2 training pipeline overview]{Overview of the DreamerV2 training pipeline. The \worldmodel{} learns to predict future states and rewards, enabling the actor-critic framework to optimize policies using imagined rollouts. Taken from Hafner et al.~\cite{hafner2021mastering}, Fig.~1.}
...
Zhang et al. \cite{zhang2022objects} show that object-centric world models
...
alternatives. Mosbach et al. \cite{mosbach2021learning} learn object-centric
...
models from pixel observations \cite{kipf2021conditional,villar2023object}.
...
actor-critic training \cite{yoon2023investigation}. The configurations
...
\cite{carion2020end,locatello2020object} might improve that by providing
