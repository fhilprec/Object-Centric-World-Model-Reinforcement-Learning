...
Model free learning often struggles with sample efficiency and generalization to
...
loopholes in the environment rather than achieving the intended goals.
Thus interpretability of learned policies usually suffers and sample efficiency is
low.
...
\cite{jaxatari}. This world model is trained to predict the next state of
the environment given the current state and action. An actor-critic
framework based on the DreamerV2 \cite{hafner2020dream} architecture is
integrated with the world model to learn policies from imagined rollouts. The
training pipeline involves alternating between updating the world model and
