...
%%
\documentclass[english,parskip=half,colors={faculties,rz},headline=color]{URletter}
...
%Sprachanpassungen -- english als Sprachoption wurde als Dokumentenklasse gesetzt
\usepackage{babel}
